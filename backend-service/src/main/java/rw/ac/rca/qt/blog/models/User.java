...
import rw.ac.rca.qt.blog.enumerations.EGender;
import rw.ac.rca.qt.blog.enumerations.EStatus;
import rw.ac.rca.qt.blog.utils.ExpirationTokenUtils;
...
public class User {
    ...
    public User(String username, String phoneNumber, String email, EGender gender, String password) {
